...
<div class="service">
	<div class="service__tabs tabs">
		<?php if( have_rows('service_lab__tabs') ): ?>
		...
		<ul class="tabs__nav service__tabs-nav">
			<?php while( have_rows('service_lab__tabs') ): the_row(); $s_inc_1++; ?>

				<?php

				$serviceTabName = get_sub_field('service_lab__tab_name');
		...
		<?php while( have_rows('service_lab__tabs') ): the_row(); $s_inc_2++; ?>
			...
			$servFormLab = get_field('service_form_lab');
			?>
			...
			<div class="service__col service__col_form col-md-4 stupid_form">
				...
				<aside class="form service__form">
					<h2 class="form__title"><?php echo $servFormLab['service_form_lab_title']; ?></h2>
					<div class="form__w">
						<?php if ($servFormLab['service_form_lab_shortcode']): ?>

						<?php echo do_shortcode($servFormLab['service_form_lab_shortcode']); ?>
