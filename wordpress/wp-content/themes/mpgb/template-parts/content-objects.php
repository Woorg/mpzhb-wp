...
echo '<div class="container obj_tabs"><nav class="navbar"><ul class="navbar-nav">';
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<li class="objects-full__item">
			<?php
				...
				$imageCaption = get_the_title( get_post_thumbnail_id() );

			?>

			<a href="<?php echo $imageFull[0]; ?>" style="background-image: url('<?php echo $imageFull[0]; ?>');" class="objects-full__link">
